  ...
  return (
    <div className="homeContainer">
      ...
      <div className="headSectionButtons">
        <button><a href="https://github.com/VenkataBalaji07" target="_blank" style={{color:"white"}}><FaGithub/></a></button>
        <button><a href="https://www.linkedin.com/in/venkata-balaji-boppudi-632b5b248" target="_blank" style={{color:"white"}}><FaLinkedin/></a></button>
        <button><a href="https://x.com/Balaji4207?t=NGov0PEfCcGWFL_1G1WlEg&s=09" target="_blank" style={{color:"white"}}><FaTwitter/></a></button>
